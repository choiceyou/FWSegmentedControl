...
class ViewController: UIViewController, UIScrollViewDelegate {
    ...
    private lazy var segmentedControl2: FWSegmentedControl = {
        ...
        segmentedControl.titleTextAttributes = [NSAttributedString.Key.foregroundColor: UIColor.gray, NSAttributedString.Key.font : UIFont.systemFont(ofSize: kSegmentTitleFont)]
        segmentedControl.selectedTitleTextAttributes = [NSAttributedString.Key.foregroundColor: UIColor.red, NSAttributedString.Key.backgroundColor: UIColor.clear, NSAttributedString.Key.font: UIFont.systemFont(ofSize: kSegmentTitleFont)]
    ...
    private lazy var segmentedControl3: FWSegmentedControl = {
        ...
        segmentedControl.segmentEdgeInset = UIEdgeInsets(top: 0, left: kSegmentLeftEdge, bottom: 0, right: kSegmentLeftEdge)
        segmentedControl.selectionStripeIndicatorFixedWidth = 20.0
    ...
    private lazy var segmentedControl4: FWSegmentedControl = {
        ...
        let segmentedControl = FWSegmentedControl.segmentedWith(scType: SCType.text, scWidthStyle: SCWidthStyle.fixed, sectionTitleArray: sectionTitles2, sectionImageArray: nil, sectionSelectedImageArray: nil, frame: CGRect(x: 0, y: Int(self.segmentedControl3.frame.maxY) + 10, width: Int(UIScreen.main.bounds.width), height: 40))
    ...
    private lazy var segmentedControl5: FWSegmentedControl = {
        ...
        let segmentedControl = FWSegmentedControl.segmentedWith(scType: SCType.text, scWidthStyle: SCWidthStyle.dynamic, sectionTitleArray: sectionTitles, sectionImageArray: nil, sectionSelectedImageArray: nil, frame: CGRect(x: 0, y: Int(self.segmentedControl4.frame.maxY) + 10, width: Int(UIScreen.main.bounds.width), height: 30))
        ...
        segmentedControl.titleTextAttributes = [NSAttributedString.Key.foregroundColor: UIColor.black, NSAttributedString.Key.font : UIFont.systemFont(ofSize: kSegmentTitleFont)]
        segmentedControl.selectedTitleTextAttributes = [NSAttributedString.Key.foregroundColor: UIColor.white, NSAttributedString.Key.backgroundColor: UIColor.clear, NSAttributedString.Key.font: UIFont.systemFont(ofSize: kSegmentTitleFont)]
    ...
    /// 例九：图文结合（横向），与scrollView结合使用
    private lazy var segmentedControl9: FWSegmentedControl = {
