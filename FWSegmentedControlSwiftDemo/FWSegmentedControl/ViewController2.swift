...
class ViewController2: UIViewController, UIScrollViewDelegate {
    ...
    private lazy var segmentedControl: FWSegmentedControl = {
        ...
        segmentedControl.titleTextAttributes = [NSAttributedString.Key.foregroundColor: UIColor.gray, NSAttributedString.Key.font : UIFont.systemFont(ofSize: CGFloat(13.0))]
        segmentedControl.selectedTitleTextAttributes = [NSAttributedString.Key.foregroundColor: UIColor.red, NSAttributedString.Key.backgroundColor: UIColor.clear, NSAttributedString.Key.font: UIFont.systemFont(ofSize: CGFloat(13.0))]
...
extension ViewController2 {
    ...
    func setupSegmentedControl(index: Int, sectionTitleArray: [String]) -> FWSegmentedControl {
        ...
        segmentedControl2.titleTextAttributes = [NSAttributedString.Key.foregroundColor: UIColor.gray, NSAttributedString.Key.font : UIFont.systemFont(ofSize: CGFloat(13.0))]
        segmentedControl2.selectedTitleTextAttributes = [NSAttributedString.Key.foregroundColor: UIColor.red, NSAttributedString.Key.backgroundColor: UIColor.clear, NSAttributedString.Key.font: UIFont.systemFont(ofSize: CGFloat(13.0))]
