#
#  Be sure to run `pod spec lint FWSegmentedControl.podspec' to ensure this is a
...
FWSegmentedControl兼容OC，借鉴了前辈项目：HMSegmentedControl，在此非常感谢前辈的分享
  ...
  s.source       = { :git => "https://github.com/choiceyou/FWSegmentedControl.git", :tag => "#{s.version}" }
